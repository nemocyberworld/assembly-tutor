...
def run():
    ...
    slow_print(f"{YELLOW}🔍 We'll go line by line, explaining what's going on — no prior experience required!{RESET}", 0.02)
    ...
    slow_print(f"{YELLOW}📦 Want to run this on your own? Here's how!{RESET}", 0.03)
    slow_print(f"""
...
""", 0.01)
    ...
    time.sleep(1)
    slow_print(f"{BOLD}🎉 Great job! You've written and understood your very first Assembly program!{RESET}", 0.02)
